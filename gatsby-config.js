module.exports = {
  plugins: [
    "gatsby-plugin-styled-components",
    {
      ...
      options: {
        website: {
              title: "DisDroid/IQI : Ochre Cache", // Homepage title
              titleShort: "DisDroid:ochre", // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation
              name: "DisDroid/Purple", // Website name used for homescreen (PWA) and SEO
              description: "DisDroid/IQI Ochre cache site.", // Website description used for RSS feeds/meta description tag
              ...
              rssTitle: "DisDroid/IQI Ochre cache site.", // Title of the RSS feed
	  ...
	  // User configuration
        user: {
    	      id: "DisDroid/IQI:ochre", // Unique identifier of the user on the website. Used for OpenGraph SEO tags
              firstName: "DisDroid/IQI", // Used for SEO
              lastName: "Ochre", // Used for SEO
              ...
              about: "DisDroid/IQI Ochre Monitor", // User information used for the author section
